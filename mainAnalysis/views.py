...
def mainStuGraph1_2(request):
    ...
    return render(request, 'mainAnalysis/1-2_mainAnalysis.html', {'data':data,'studentId':studentId,'studentName':studentName})
...
def mainStuGraph3_1(request):
    ...
    return render(request, 'mainAnalysis/3_2Analysis.html', {'data':data,'studentId':studentId,'studentName':studentName})
